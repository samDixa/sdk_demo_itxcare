...
public class SerialPortActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        for (int i = 0; i < 2; ++i) {
            ...
            rootLayout.addView(comNode.bindView(this), new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.WRAP_CONTENT, 1.0f));
...
class ComUnit extends Thread implements
    ...
    public View bindView(SerialPortActivity activity) {
        ...
        mCmbBaudRate.setAdapter(new ArrayAdapter<Integer>(mActivity,
    ...
    public void onClick(View v) {
        if (v == null) {
            ...
            if (mBtOpen.getText().toString().equals(mBtOpen.getResources().getString(R.string.serialport_open))) {
                mBtOpen.setText(mBtOpen.getResources().getString(R.string.serialport_close));
                onBtOpen();
            } else {
                mBtOpen.setText(mBtOpen.getResources().getString(R.string.serialport_open));
                onBtClose();
            }
...
//		mBtOpen.setEnabled(true);
    ...
    private void onBtSend() {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(mActivity);
        final EditText edtHex = new EditText(mActivity);
